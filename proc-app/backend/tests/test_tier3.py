...
def fresh_t3_engagement():
    ...
    # Pre-fill QRE so QRE-dependent pillars (DoA, Org Structure) compute
    # themes + scores (otherwise PPT generator + comparison delta both
    # crash on None scores from the needs_qre stub).
